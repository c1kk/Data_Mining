...
#For training
def train() -> None:
    with open('D:/Semes 7 -  2022 2023/Khai thác/12_19521694_NguyenCaoKhoa/12_19521694_DuLieuEncoding.csv') as f:
        df = pd.read_csv(f)
    ...
    dataset = dataset[['MonthlyIncome', 'StockOptionLevel', 'MonthlyRate', 'DailyRate', 'JobInvolvement', 'Attrition']]
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "StockOptionLevel"))
        self.label_3.setText(_translate("MainWindow", "MonthlyRate"))
        self.label_4.setText(_translate("MainWindow", "DailyRate"))
        self.label_5.setText(_translate("MainWindow", "JobInvolvement"))
